...
\begin{center}
  \textbf{\Large qu'est ce qu'un {\Huge Algorithme}}
...
\begin{spacing}{.8}
  ...
  \centerline{\footnotesize ainsi que des vidéos explicatives}    
...
\end{minipage}~\begin{minipage}{.5\linewidth}\center
  \maisonCinq{1/C,2/B, 5/E,6/C,   9/D, 13/B,14/A, 17/A,18/D}{
    ...
    \draw[<->,ultra thick,draw=red,bend left=45] (cc 5) -- (cc 3);
  }
...
\begin{minipage}{.63\linewidth}
  ...
  plateau trié, l'algorithme de s'arrête jamais car les pions ne
...
\vspace{-.5\baselineskip} %
En trois activités débranchées, nous avons découvert que les
algorithmes sont simples et utiles. Les algorithmiciens en appliquent
à la vie de tous les jours, méthodiquement.
...
de nombreuses ressources libres en ligne pour cela.
