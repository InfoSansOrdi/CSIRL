...
\uppertitleback{
  ...
  "Sciences Manuelles du Numérique" est un \textbf{projet libre et ouvert}~:
  vous pouvez copier et modifier librement les ressources de ce projet sous les
  conditions données par la CC-BY-SA (en bref, vous pouvez diffuser et modifier
  ces ressources à condition que vous donniez les mêmes droits aux utilisateurs
  de vos copies).
