...
\begin{frame}{}
  ...
  \begin{center}
    ...
    \bigskip
    \includegraphics[width=.7\linewidth]{img/Hamiltonian_path.pdf}
    \rotatebox{90}{\tiny\url{http://en.wikipedia.org/wiki/File:Hamiltonian_path.svg}
      (CC-BY-SA)}
  \end{center}
  
  \bigskip
  \bigskip
  {\hfill\small\url{http://wiki.nybi.cc/index.php/CSIRL}~~}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}{Activité: le jeu de Nim}
  ...
  \bigskip\bigskip
  \centerline{\includegraphics[height=20\baselineskip]{img/Pyramidal_matches.pdf}
  %
  \rotatebox{90}{\tiny\url{http://fr.wikipedia.org/wiki/Fichier:Pyramidal_matches.svg}
    (CC-BY-SA)}} 
