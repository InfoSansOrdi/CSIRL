...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\maisonQuatre}[2]{  \begin{tikzpicture}
    ...
    \foreach \base/\maison in {1/A,2/B,3/C,4/D} {
...
\newcommand{\maisonCinq}[2]{  \begin{tikzpicture}
    \node[name=m,shape=regular polygon,regular polygon sides=5,inner sep=.7cm]{};
    \node[name=b,shape=regular polygon,regular polygon sides=20,inner sep=.57cm]{};
    \foreach \base/\maison in {1/A,2/B,3/C,4/D,5/E} {
      \draw[shift=(m.corner \base)] 
...
%  \bigskip
  \begin{columns}
    \begin{column}{.17\linewidth}
      \maisonQuatre{2/B,3/A, 5/D,6/Z, 8/B,9/C, 11/D,12/A} {}
    ...
    \end{column}
    \begin{column}{.17\linewidth}
      \maisonQuatre{11/A,12/A, 2/B,3/B, 5/C,6/Z, 8/D,9/D}{}
