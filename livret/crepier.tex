\begin{frame}{Activité: Le crêpier psycho-rigide}
  ...
  \begin{block}{Règle du jeu}
    \begin{itemize}
    \item Objectif : ranger les crêpes de la plus grande (en dessous)
      à la plus petite (au dessus), face colorée vers le haut.
    \item La seule action possible est de prendre une ou plusieurs crêpes sur
      le haut de la pile, et de les reposer à l'envers.
    \end{itemize}
  \end{block}
